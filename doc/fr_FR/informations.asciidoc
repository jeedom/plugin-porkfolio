...
* A : Tête du cochon qui peut changer d'humeur. En laissant la souris sur sa tête il vous dira quand il a bougé pour la dernière fois ainsi que la dernière fois ou il a été retourné
